...
public class ScheduleServiceTest {
    ...
    void syncScheduleUrgentOrder() throws ParseException {
        ...
        serviceImpl.scheduleInsertUrgentOrder(input, dateFormat.parse("2020-11-3 19"),
                new ScheduleInputDto.Order("urgent 1", "紧急订单 1", true, 5, 5, Arrays.asList("g1", "g15", "g16", "g40"),
                        Arrays.asList("mt1", "mt3", "mt4"), dateFormat.parse("2020-11-4 12")));
    ...
    private ScheduleInputDto genSimpleInput() throws ParseException {
        ...
        groups.add(new ScheduleInputDto.Group("g14", "14组-周  清（4）", 4, Arrays.asList(new TimeIntervalDto(7, 19))));
        groups.add(new ScheduleInputDto.Group("g16", "16组-朱美（4）", 4,
                Arrays.asList(new TimeIntervalDto(19, 24), new TimeIntervalDto(0, 7))));
        groups.add(new ScheduleInputDto.Group("g40", "40组-高燕（5）", 5, Arrays.asList(new TimeIntervalDto(7, 19))));
        ...
        orders.add(new ScheduleInputDto.Order("413095", "订单413095", false, 8, 8, Arrays.asList("g5", "g9", "g1", "g12"),
                Arrays.asList("mt1", "mt2"), dateFormat.parse("2020-11-4 10")));
        orders.add(
                new ScheduleInputDto.Order("414837", "订单414837", false, 8, 8, Arrays.asList("g3", "g14", "g16", "g40"),
                        Arrays.asList("mt2", "mt3"), dateFormat.parse("2020-11-4 12")));
        orders.add(
