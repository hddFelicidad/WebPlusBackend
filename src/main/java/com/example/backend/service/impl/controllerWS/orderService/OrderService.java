 ...
 * 
 */
@WebServiceClient(name = "OrderService", targetNamespace = "http://impl.Service/", wsdlLocation = "http://localhost:8080/OrderService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName ORDERSERVICE_QNAME = new QName("http://impl.Service/", "OrderService");
    ...
    public OrderServiceSoap getOrderServiceSoapPort() {
        return super.getPort(new QName("http://impl.Service/", "OrderServiceSoapPort"), OrderServiceSoap.class);
    }
     ...
     */
    @WebEndpoint(name = "OrderServiceSoapPort")
    public OrderServiceSoap getOrderServiceSoapPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://impl.Service/", "OrderServiceSoapPort"), OrderServiceSoap.class, features);
    }
